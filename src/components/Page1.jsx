      ...
      <div className="w-1/2">
        <div className=" pl-[10%]">
          ...
          <div className="mt-[40px]">
            <button className="bg-[#a2e100] hover:bg-[#a8c955] font-medium text-black rounded-[50px] py-4 px-6">
              <Link to="/Getstarted">Get Started</Link>
            </button>
          </div>
          <div className="mt-[10px]">
            <button className="bg-[white] border-2 border-[#a2e100] hover:bg-[#a2e100] font-medium text-black rounded-[50px] py-4 px-6">
